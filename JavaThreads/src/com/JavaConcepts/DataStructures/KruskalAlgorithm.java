...
public class KruskalAlgorithm {
	...
	public void krushalAlgorithm(int adjacencyMatrix[][]){
		...
		for(int source=1; source<=numberOfVertices; source++){
			...
			for(int destination=1; destination<=numberOfVertices; destination++){
				System.out.println(spanning_tree[source][destination]+"\t");
			}
			System.out.println();
		}
	}
	...
	public static void main(String[] args) {
		...
		KruskalAlgorithm krAlgorithm = new KruskalAlgorithm(number_of_vertices);
		krAlgorithm.krushalAlgorithm(adjacency_matrix);
		scan.close();
	}
}
